# Edugonmor Cookiecutter Project

Este repositorio contiene una plantilla de proyecto basada en **Cookiecutter**, siguiendo los estándares de infraestructura "Edugonmor Pattern".
...
1.  **Nomenclatura de Servicios:**
    *   Servicio Principal: `edugonmor_cookiecutter_services`
    *   Servicio de Backup: `edugonmor_cookiecutter_backup` (si aplica)
    *   Contenedores: `container_name: edugonmor_cookiecutter_<rol>`
2.  **Configuración:**
    *   Uso obligatorio de archivo `.env`.
    *   Credenciales inyectadas vía variables de entorno.
3.  **Redes:**
    *   Red dedicada: `edugonmor_cookiecutter_network`
