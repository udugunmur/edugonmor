...
> Si usas varias cuentas, repite el bloque cambiando el nombre del remoto: `[onedrive-edugonmor_backup]`, `[onedrive-edugonmor_data]`, `[onedrive-edugonmor_media]`, `[onedrive-edugonmor_business]`.
...
```bash
cd docker
docker-compose up -d rclone_onedrive_edugonmor_service
```
