...
🏠 Portal Principal de Documentación (Nexus 3): Este es el "índice maestro".

https://help.sonatype.com/repomanager3

🐳 Documentación Oficial de la Imagen Docker: Aquí explican las variables de entorno, volúmenes y configuración técnica del contenedor.

https://hub.docker.com/r/sonatype/nexus3

📄 Guía para configurar Repositorios Proxy (Tu caso de uso): Esta es la página exacta que explica cómo conectar Nexus a Docker Hub o NPM para que empiece a guardar copias.

https://help.sonatype.com/repomanager3/repository-management/proxy-repository
