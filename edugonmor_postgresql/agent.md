...
|----------|-------|-----------|-------------|
| `POSTGRES_USER` | `edugonmor_postgresql_user` | `.env` | Usuario de PostgreSQL |
| `POSTGRES_PASSWORD` | `edugonmor_postgresql_password` | `docker/secrets/db_password.txt` | Contraseña del usuario |
| `POSTGRES_DB` | `postgres` | `.env` | Base de datos por defecto |
