...
**Restauración:**
```bash
cat backup_YYYYMMDD_HHMMSS.sql | docker exec -i postgresql_services psql -U postgres -d postgres
```
...
docker stats postgresql_services
```
...
2. Verificar healthcheck: `docker inspect postgresql_services`
