...
# ============================================================================
# Documentación: https://www.postgresql.org/docs/{{cookiecutter.postgres_version}}/backup.html
# Descripción: Realiza backup completo de PostgreSQL usando pg_dump

set -e

# Configuración
BACKUP_DIR="{{cookiecutter.rclone_base_path}}/{{cookiecutter.project_slug}}"
