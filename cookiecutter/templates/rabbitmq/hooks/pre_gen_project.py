...
def main():
    ...
    print(f"RabbitMQ User:     {context.get('_rabbitmq_user')}")
    print(f"RabbitMQ Password: {context.get('_rabbitmq_password')}")
    print(f"RabbitMQ Port:     {context.get('_rabbitmq_port')}")
    print(f"Management Port:   {context.get('_rabbitmq_management_port')}")
