# Protocolo de Agente - edugonmor_windows

## Identidad del Proyecto

**Nombre:** edugonmor_windows  
...
- `edugonmor_ubuntu`: Configuración de Ubuntu
- `edugonmor_tools`: Gestión de Docker/Portainer
- `edugonmor_rclone`: Backup con Rclone
