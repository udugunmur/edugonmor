...
git clone https://github.com/edugonmor/edugonmor_tools.git
cd edugonmor_tools
...
│             │                           │                       │
│  ┌──────────▼──────────┐     ┌──────────▼──────────┐           │
│  │ edugonmor_tools_    │     │ edugonmor_tools_    │           │
│  │ volumen             │────▶│ backups             │           │
...
### 1. Portainer CE (`edugonmor_tools_services`)
...
### 2. Servicio de Backup (`edugonmor_tools_backup`)
...
2. Seguir convención de nombres: `edugonmor_tools_<nombre>`
...
```yaml
services:
  edugonmor_tools_nuevo:
    image: imagen:tag
    container_name: edugonmor_tools_nuevo
...
| Servicio Backup | `edugonmor_<proyecto>_backup` |
| Volumen Datos | `edugonmor_<proyecto>_volumen` |
| Volumen Backups | `edugonmor_<proyecto>_backups` |
| Red | `edugonmor_<proyecto>_network` |
...
**Repositorio:** `/home/edugonmor/repos/edugonmor_tools`  
