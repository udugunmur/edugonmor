...
|----------|------------|---------|
| Servicio Principal | `edugonmor_<proyecto>_services` | `edugonmor_tools_services` |
| Servicio Backup | `edugonmor_<proyecto>_backup` | `edugonmor_tools_backup` |
| Contenedor | `edugonmor_<proyecto>_<rol>` | `edugonmor_tools_services` |
| Volumen Datos | `edugonmor_<proyecto>_volumen` | `edugonmor_tools_volumen` |
| Volumen Backups | `edugonmor_<proyecto>_backups` | `edugonmor_tools_backups` |
| Red | `edugonmor_<proyecto>_network` | `edugonmor_tools_network` |
...
| Puerto HTTPS | 9443 |
| Puerto HTTP | 9000 |
| Volumen | `edugonmor_tools_volumen:/data` |
